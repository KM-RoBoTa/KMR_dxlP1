...
struct MX_64_P1 : ControlTable {
	MX_64_P1 ()
    {
        ...
        consumedCurrent.addr = 68;
        consumedCurrent.length = 2;
        consumedCurrent.unit = 0.0045;
        enableTorqueMode.addr = 70;
        enableTorqueMode.length = 1;
        enableTorqueMode.unit = 1;
        goalTorque.addr = 71;
        goalTorque.length = 2;
